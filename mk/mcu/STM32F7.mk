...
LWIP_DIR = $(ROOT)/lib/main/lwip/src
VPATH := $(VPATH):$(LWIP_DIR)/core:$(LWIP_DIR)/core/ipv4:$(LWIP_DIR)/netif
INCLUDE_DIRS += $(LWIP_DIR)/include $(ROOT)/src/main/io/lwip_port
VCP_SRC += \
            drivers/stm32/vcp_hal/usbd_cdc_ncm.c \
            drivers/stm32/phoneconfig_usb_f7xx.c \
